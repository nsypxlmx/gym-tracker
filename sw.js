const CACHE="gymtracker-mono-v4";
const ASSETS=["./","./index.html","./manifest.json","./icon-192.png","./icon-512.png","./icon-512-maskable.png","./icon-180.png","./pdfjs/pdf.min.mjs","./pdfjs/pdf.worker.min.mjs"];
